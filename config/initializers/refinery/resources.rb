...
Refinery::Resources.configure do |config|
  ...
  # config.dragonfly_secret          = "6b5a952276eb8bc80dd2336092331af2d734c030e6cadec5"
  # config.dragonfly_url_host        = ""
  # config.dragonfly_datastore_root_path = "/workspaces/RoR-Test2/public/system/refinery/resources"
